...
\begin{itemize}
    ...
    \item Frente a enfoques previos centrados en replicar tutoriales, aquí se plantea un protocolo comparativo consistente (mismas métricas, mismas semillas y barridos de hiperparámetros) y se contrasta tabular vs aproximado en entornos discretos y continuos, aportando evidencia empírica más completa y reproducible.
\end{itemize}
